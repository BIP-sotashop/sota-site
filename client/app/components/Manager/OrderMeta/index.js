...
const OrderMeta = props => {
  ...
  const renderMetaAction = () => {
    ...
    if (isNotDelivered) {
      return <Button size='sm' text='Отменить заказ' onClick={cancelOrder} />;
    }
  };
  ...
  return (
    <div className='order-meta'>
      <div className='d-flex align-items-center justify-content-between mb-3 title'>
        <h2 className='mb-0'>Детали заказа</h2>
        <Button
          variant='link'
          icon={<ArrowBackIcon />}
          size='sm'
      ...
      <Row>
        <Col xs='12' md='8'>
          <Row>
            <Col xs='4'>
              <p className='one-line-ellipsis'>ID заказа</p>
            </Col>
            <Col xs='8'>
          ...
          <Row>
            <Col xs='4'>
              <p className='one-line-ellipsis'>Дата заказа</p>
            </Col>
            <Col xs='8'>
