  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Станьте продавцом на SOTASHOP!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Хотите продавать свои товары на SOTASHOP?</h3>
                  <h5>Развивайте свой бизнес с SOTASHOP</h5>
                  <b>Подайте заявку сегодня</b>
                </div>
              </Col>
